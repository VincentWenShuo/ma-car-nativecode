...
@implementation MaCarNativecodeSlideViewProxy
...
-(void)_initWithProperties:(NSDictionary *)properties
{
    ...
    [self initializeProperty:@"touchWidth" defaultValue:NUMFLOAT(0)];
    [self initializeProperty:@"pageWidth" defaultValue:NUMFLOAT(0)];
    [self initializeProperty:@"curPage" defaultValue:NUMINT(0)];
    [self initializeProperty:@"pageNum" defaultValue:NUMINT(0)];
